...
public class CommandModule(ILogger<CommandModule> logger) : InteractionModuleBase<SocketInteractionContext>
{
    ...
    public async Task OptionsTestAsync([Summary("parameter0", "Just a description")] string? parameter1 = null,
        ...
        [Summary("parameter20", "Just a description")]
        string? parameter21 = null,
        [Summary("parameter21", "Just a description")]
        string? parameter22 = null,
        [Summary("parameter22", "Just a description")]
        string? parameter23 = null,
        [Summary("parameter23", "Just a description")]
        string? parameter24 = null,
        [Summary("parameter24", "Just a description")]
        string? parameter25 = null)
    {
